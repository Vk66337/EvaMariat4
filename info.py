...
API_ID = int(environ.get('API_ID', '17771098'))
API_HASH = environ.get('API_HASH', 'd52822967d9537baeb2891ea6fcef6b6')
BOT_TOKEN = environ.get('BOT_TOKEN', '5339183516:AAEi_6NmRY1TXU_soC5WW5f72HrzlJK86LY')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5310171268').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://visbwjjkmMm:hsjwjw727Hh@cluster0.uegicvu.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Anurag")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Anurag_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001634208490'))
